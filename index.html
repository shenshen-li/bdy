...
<header class="w3-display-container w3-center">
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="MainPage.png" alt="Image 1" style="min-width:500px" width="500" height="100">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge">Record your life with our app</h1>
        <hr class="w3-opacity">
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="CreatePage.png" alt="Image 2" style="min-width:500px" width="500" height="100">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge w3-text-red"><b>CLICK!</b> Fast and Easy</h1>
        <hr class="w3-opacity">
        <p>An offline diary that keeps your thought, photos all in one place.</p>
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="ViewPage.png" alt="Image 3" style="min-width:500px" width="500" height="100">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge">Personalized Design</h1>
        <hr class="w3-opacity">
        <p>Record your feelings today!</p>
...
<div class="w3-padding-64 w3-white">
  <div class="w3-row-padding">
    <div class="w3-col l8 m6">
      ...
      <p><span class="w3-xlarge">Record your life in a few seconds.</span> You should use this app because Thomas buid it!</p>
    ...
    <div class="w3-col l4 m6">
      <img src="ViewPage2.png" class="w3-image w3-right w3-hide-small" width="335" height="471">
...
<div id="download" class="w3-modal w3-animate-opacity">
  <div class="w3-modal-content" style="padding:32px">
    <div class="w3-container w3-white">
      ...
      <p>Download the app in Microsoft Store.</p>
...
<div class="w3-padding-64 w3-center w3-white">
  <h1 class="w3-jumbo"><b>Versions</b></h1>
  <p class="w3-large">list of versions and features</p>
  <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-half w3-section">
      <ul class="w3-ul w3-card w3-hover-shadow">
          <li class="w3-dark-grey w3-xlarge w3-padding-32">Instary 1.1</li>
        <li class="w3-padding-16"><b>Add picture with camera option</b> </li>
        <li class="w3-padding-16"><b> Show your list is empty when there is no instary</b> </li>
        <li class="w3-padding-16">Sort by date</li>
        <li class="w3-padding-16">Dark Mode</li>
        <li class="w3-padding-16"> Star to save special instary</li>
    ...
    <div class="w3-half w3-section">
      <ul class="w3-ul w3-card w3-hover-shadow">
        <li class="w3-red w3-xlarge w3-padding-32">Instary 1.2</li>
        <li class="w3-padding-16"> Search by date</li>
        <li class="w3-padding-16">Import/ Export Instary</li>
        <li class="w3-padding-16"> Add chart to view progress</li>
        <li class="w3-padding-16"> Add video option</li>
        <li class="w3-padding-16">  Add security like password/ fingerprint lock the app</li>
